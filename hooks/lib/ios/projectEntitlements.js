...
/**
 * Detect the cordova-ios 8+ project layout by the per-configuration
 * entitlement files under platforms/ios/App/.
 *
 * @return {Boolean}
 */
...
/**
 * Add associated domains to both entitlement files generated by cordova-ios 8.
 * Existing entitlement keys are preserved.
 *
...
function writeAssociatedDomainsForCordovaIos8(pluginPreferences) {
  ...
  ['Entitlements-Debug.plist', 'Entitlements-Release.plist'].forEach(function(name) {
    ...
    try {
      ...
      // The file may not exist yet; create it with the required key below.
    }
